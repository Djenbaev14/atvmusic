...
<!-- Mirrored from demos.themeselection.com/materio-bootstrap-html-laravel-admin-template-free/demo/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Nov 2023 06:05:55 GMT --><!-- Added by HTTrack -->
...
<head>
    ...
    <!-- laravel CRUD token -->
    <meta name="csrf-token" content="q3Doe92TjGdCgwvgaKx8RGnqydJ0elmwt7tyVGNJ">
    <!-- Canonical SEO -->
...
<body class="body">
        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" data-bg-class="bg-menu-theme">
                    ...
                    <a href="/" class="app-brand-link">
                        <span class="app-brand-logo demo me-1">
                            <span style="color:#9055FD;">
                                <img src="{{asset('images/ATV.png')}}" width="30" height="20" alt="">
                        ...
                        <span class="app-brand-text demo menu-text fw-semibold ms-2">ATV</span>
                    </a>
                ...
                <ul class="menu-inner py-1 ps ps--active-y">
                    ...
                    <li class="menu-item treatment_main123">
                        <a href="javascript:void(0);" class="menu-link menu-toggle waves-effect">
                            <i class="menu-icon tf-icons mdi mdi-cube-outline"></i>
                            <div>О нас</div>
                        </a>
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end mt-3 py-2">
                                    <li>
                                        <a class="dropdown-item pb-2 mb-1 waves-effect" href="javascript:void(0);">
    ...
    <!-- Include Scripts -->
    <!-- BEGIN: Vendor JS-->
    <script src="/assets/vendor/libs/jquery/jquery6eb7.js?id=fbe6a96815d9e8795a3b5ea1d0f39782"></script>
    <script src="/assets/vendor/libs/popper/poppere728.js?id=bd2c3acedf00f48d6ee99997ba90f1d8"></script>
    <script src="/assets/vendor/js/bootstrap05f9.js?id=0a1f83aa0a6a7fd382c37453e3f11128"></script>
    <script src="/assets/vendor/libs/node-waves/node-wavesa75b.js?id=0ca80150f23789eaa9840778ce45fc5c"></script>
    <script src="/assets/vendor/libs/perfect-scrollbar/perfect-scrollbard295.js?id=f4192eb35ed7bdba94dcb820a77d9e47">
    </script>
    <script src="/assets/vendor/js/menuadfb.js?id=201bb3c555bc0ff219dec4dfd098c916"></script>
    <script src="/assets/vendor/libs/apex-charts/apexcharts.js"></script>
    <!-- END: Page Vendor JS-->
    <!-- BEGIN: Theme JS-->
    <script src="/assets/js/main270c.js?id=4f816bbbc912e9a5bcff6119bc265966"></script>
    ...
    <script>
        ...
        if (window.location.pathname == '/employees/create') {
            $('.emp2').addClass('active')
            $('.emp_main').addClass('open')

        };
        if (window.location.pathname == '/employees') {
            $('.emp1').addClass('active')
            $('.emp_main').addClass('open')

        };
        if (window.location.pathname == '/treatments') {
            $('.treat1').addClass('active')
        ...
        if (window.location.pathname == '/typetreatments') {
            $('.treat3').addClass('active')
            $('.treatment_main').addClass('open')
        };
        if (window.location.pathname == '/typetreatments/create') {
            $('.treat4').addClass('active')
            $('.treatment_main').addClass('open')
        };

     if (window.location.pathname == '/about') {
            $('.treat123').addClass('active')
            $('.treatment_main123').addClass('open')
        };
